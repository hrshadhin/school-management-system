...
[![php](https://img.shields.io/badge/php-8.0-brightgreen.svg?logo=php)](https://www.php.net)
[![laravel](https://img.shields.io/badge/laravel-9.x-orange.svg?logo=laravel)](https://laravel.com)
...
Another School Management System build with Laravel 9 and PHP 8

## :loudspeaker: **Upgrading to PHP 8 & Laravel 9 [WIP]:**
...
#### To-do
- [ ] Upgrade to support php 8.x & Laravel 9.x[**WIP**]
