                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control" name="designation" placeholder="Head Master, Sr. Teacher" value="@if($employee){{ $employee->designation }}@else{{old('designation')}}@endif"  maxlength="255">
                                        <span class="fa fa-info form-control-feedback"></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type='text' class="form-control date_picker2"  readonly name="joining_date" placeholder="date" value="@if($employee){{$employee->joining_date}}@else{{ old('joining_date') }}@endif" required minlength="10" maxlength="255" />
                                        <span class="fa fa-calendar form-control-feedback"></span>
