    ...
    <div class="row">
        ...
        <div class="card light_blue hrbc" style="@if($templateConfig->bg_color) background-color:{{$templateConfig->bg_color}}; @endif @if($templateConfig->border_color) border-color:{{$templateConfig->border_color}}; @endif">
            ...
            <div class="content">
                ...
                @endif
                <span class="id_title" @if($templateConfig->id_title_color) style="color:{{$templateConfig->id_title_color}};"@endif>STUDENT ID CARD</span>
                <span class="student_pic">
                        <img class="border_blue" @if($templateConfig->picture_border_color) style="border-color:{{$templateConfig->picture_border_color}};"@endif src="@if($student->student->photo ){{ asset('storage/student')}}/{{ $student->class_id }}/{{ $student->student->photo }} @else {{ asset('images/avatar.jpg')}} @endif" />
                    </span>
                <table border="0" cellpadding="0" cellspaing="0">
                    ...
                    <tr>
                        ...
                        <td class="bold">:</td>
                        <td>@if($student->house){{$student->house}}@endif</td>
                    </tr>
                    <tr>
