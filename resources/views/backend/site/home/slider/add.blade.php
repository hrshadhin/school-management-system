                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input autofocus type="text" class="form-control" name="title" placeholder="title" required minlength="5" maxlength="255">
                                <span class="glyphicon glyphicon-info form-control-feedback"></span>
                                <span class="text-danger">{{ $errors->first('title') }}</span>
                            </div>
                            <div class="form-group has-feedback">
                                <label for="subtitle">Sub Title</label>
                                <input  type="text" class="form-control" name="subtitle" placeholder="subtitle" required minlength="5" maxlength="255">
                                <span class="glyphicon glyphicon-info form-control-feedback"></span>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input  type="number" class="form-control" name="order" placeholder="order" required min="0">
                            <span class="glyphicon glyphicon-info form-control-feedback"></span>
