<footer class="main-footer">
    <div class="pull-right">
        ...
        <strong>CloudSchool v{{$majorVersion}}.{{$minorVersion}}.{{$patchVersion}}-{{$suffixVersion}} | {{substr($idc,0,7)}}</strong> || Developed by <a class="cplink" href="{{$maintainer_url}}">{{$maintainer}}</a>
    </div>
