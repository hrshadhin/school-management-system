<footer class="main-footer">
    ...
    <strong>Copyright &copy; {{date('Y')}} <a href="#">@if(isset($appSettings['institute_settings']['name'])){{$appSettings['institute_settings']['name']}}@else CloudSchoolBD @endif</a>.</strong> All rights
    reserved.
  </footer>