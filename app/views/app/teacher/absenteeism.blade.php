        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div data-original-title="" class="box-header well">
                    <h2><i class="glyphicon glyphicon-book"></i> Absenteeism Report</h2>
                ...
                <div class="box-content">
                    ...
                    <form role="form" action="/teacher-attendance/absenteeism-report" method="get" enctype="multipart/form-data">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {{ Form::select('egroup',$data,null,['class'=>'form-control','required'=>'true'])}}
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            $("#btnPrint" ).click(function() {
                ...
                var url =  window.location.origin+"/teacher-attendance/absenteeism-report?"+qstring;
