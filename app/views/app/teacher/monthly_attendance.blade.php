        ...
        <div class="box col-md-12">
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    <form role="form" action="/teacher-attendance/monthly-report" method="get" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            $("#btnPrint" ).click(function() {
                ...
                var url =  window.location.origin+"/teacher-attendance/monthly-report?"+qstring;
