...
@section('content')
  @if (Session::get('success'))
    <div class="alert alert-success">
      ...
      <strong>Process Success.</strong> {{ Session::get('success')}}<br><a href="/workoutside">View List</a><br>
    ...
    <div class="box col-md-12">
      <div class="box-inner">
        <div data-original-title="" class="box-header well">
          <h2><i class="glyphicon glyphicon-user"></i> New Work Outside Etnry</h2>
        ...
        <div class="box-content">
          ...
          @endif
          <form role="form" action="/workoutside/store" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                  <div class="form-group ">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text"   class="form-control datepicker" name="workDate" required  data-date-format="dd/mm/yyyy">
                    </div>
                  </div>
                </div>
