      ...
      <div class="box-content">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-2"></div>
            <div class="col-md-3">
              <strong class="text-info font-16" >Birth Registration Number :</strong>
            </div>
            <div class="col-md-7">
              <label>{{$student->birthRegiNo}} </label>
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="col-md-2"></div>
            <div class="col-md-3">
              <strong class="text-info font-16" >Parent NID :</strong>
            </div>
            <div class="col-md-7">
              <label>{{$student->parentNid}} </label>
            </div>
          </div>
        </div>
        <div class="row">
