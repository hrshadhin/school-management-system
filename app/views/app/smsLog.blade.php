              ...
              <div class="col-md-4">
                ...
                <div class="form-group ">
                  ...
                  <div class="input-group">
                    ...
                    <input value="{{date('Y-m-d')}}"  type="text"   class="form-control datepicker" name="fromDate" required   data-date-format="yyyy-mm-dd">
                  </div>
              ...
              <div class="col-md-4">
                <div class="form-group ">
                  ...
                  <div class="input-group">
                    ...
                    <input value="{{date('Y-m-d')}}" type="text" class="form-control datepicker" name="toDate" required  data-date-format="yyyy-mm-dd">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i> </span>
                  </div>
