    ...
    <div class="row">
        <div class="box col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <label for="photo" class="text-danger">[File Size must be Less than 200KB]</label><br>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group ">
                                        <img id="imgPreview" src="" height="150" width="180" alt="Image preview...">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <label for="photo" class="text-danger">[File Size must be Less than 200KB]</label><br>
                                        <label id="lblmsgsignature" class="text-danger"></label>
                                        <input id="signature" name="signature" size="50" onchange="previewFile2()" required type="file">
                                    </div>
                                </div>

                                <div class="col-md-2">
                                    <div class="form-group ">
                                        <img id="imgPreview2" src="" height="150" width="180" alt="Image preview...">
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="motherCellNo">Address </label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                            <textarea  class="form-control" required name="address" placeholder=""></textarea>
                        </div>
                    </div>
                </div>
                </div>
...
<script type="text/javascript">
    ...
    function previewFile2() {
        var preview = $('#imgPreview2');
        var file    = document.querySelector('input[name="signature"]').files[0];
        var reader  = new FileReader();
        ...
        if (sizeImg<=200) {
            reader.readAsDataURL(file);
            $('#lblmsgsignature').text('');
        } else {
            preview.attr('src','');
            document.getElementById("photo").value = "";
            $('#lblmsgsignature').text('File is Too big!');
        }
