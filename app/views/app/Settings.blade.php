        ...
        <div class="box col-md-12">
            <div class="box-inner">
                <div data-original-title="" class="box-header well">
                    <h2><i class="glyphicon glyphicon-cog"></i> Change Settings</h2>
                        ...
                        <form role="form" action="/settings" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" required name="firstname" placeholder="Mr." value="{{$set->firstname}}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="type">Login Id</label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="text" readonly="true" class="form-control" required name="login" placeholder="admin" value="{{$set->login}}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="email" readonly="true" class="form-control" required name="email" placeholder="admin@school.com" value="{{$set->email}}">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="password" class="form-control" required name="npassword" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="password" class="form-control" required name="cnpassword" placeholder="">
                                            </div>
                                        </div>
                                    </div>
