                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        <img class="img responsive-img" style="height:150px;width:200px;" src="<?php echo url();?>/admission/{{$student->signature}}" alt="signature">
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-3">
                                        <strong class="text-info font-16" >Address :</strong>
                                    </div>
                                    <div class="col-md-7">
