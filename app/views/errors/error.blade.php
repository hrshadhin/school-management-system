              ...
              <div class="container">
                  <div class="row row1">
                      <div class="col-md-12">
                          ...
                          <p style="visibility: visible;-webkit-animation-delay: 2s; -moz-animation-delay: 2s; animation-delay: 2s;" class="center wow bounceIn animated" data-wow-delay="2s">Error occured! Please contact site administrator.</p>
                      </div>
                  </div>
