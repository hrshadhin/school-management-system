...
class subjectController extends \BaseController {
    ...
    public function __construct() {
        ...
        $this->beforeFilter('auth', array('only'=>array('index','create','show','edit','update','delete')));
	...
	public function show()
	{
        ...
        $Subjects=	DB::table('Subject')
            ...
            ->select('Subject.id', 'Subject.code','Subject.name','Subject.type', 'Subject.subgroup','Subject.stdgroup','Subject.totalfull',
                'Subject.totalpass','Subject.wfull', 'Subject.wpass','Subject.mfull','Subject.mpass','Class.Name as class','Subject.sfull','Subject.spass',
	...
	public function getmarks($subject)
	{
		$subject = Subject::select('totalfull','totalpass','wfull','wpass','mfull','mpass','sfull','spass','pfull','ppass')->where('code','=',$subject)->get();
		return $subject;
	}
